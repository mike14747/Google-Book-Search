...
function Home() {
    ...
    return (
        <div style={styles}>
            ...
            <a href="/search" className="btn btn-primary btn-lg mr-5 mt-4" role="button">Search</a>
            <a href="/saved" className="btn btn-success btn-lg ml-5 mt-4" role="button">Saved</a>
        </div>
    );
}
